...
var textParagraphs = [
    ...
    [4,"<p>Tea contains polyphenols, caffeine, and theanine are three chemicals present in tea. Polyphenols make up as much as 40% of the leaf's mass. Polyphenols provide color, flavor, antioxidant properties, and a dry-mouth feeling after drinking tea. Tea contains 1-6% caffeine, an addictive stimulant. Tea also contains theanine, a drug that synergises with caffeine for various psychological benefits.</p>"],
    [5,"<p>The drink contains caffeine, an addictive stimulating drug. Caffeine increases alertness and energy, but has many negative side effects. These include heart problems, increased blood pressure, irritability, sleeplessness, prostate cancer, and bone thinning. Tea has also been proven to have some healthy side effects, like boosting endurance and possibly helping to prevent cancer.</p>"]
